...
reconcile_form.geometry("1500x1000")
...
headingfont = font.Font(family='Times New Roman', size=35,)
credit_heading = Label(heading_frame, text="RECONCILED", fg='#fff',
                       bg='#243e55', height=4, bd=5, relief="groove", font=headingfont, width=150)
...
title_lab.place(x=340, y=130, height=15, width=100)
drop2.place(x=360, y=160, height=40, width=450)
