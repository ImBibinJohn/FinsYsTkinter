...
#     global eName,eJoiningdate,eEmployeenumber,eDesignation,eDepartment,eBranch,eLocation,eGender,eAge,eMobile,eGmail,eAddress,eProvidebankdetails,eBankaccountnumber,eIfsccode,eTotalrentpaid,eHrareceived,eLivein,eApplicabletaxregime,ePannumber,eAadhaarnumber,eUniversalaccountnumber,ePfaccountnumber,eEpsaccountnumber,ePraccountnumber,eEsinumber,eEsidispensaryname,eBasic,eDa,eOthincome1,eOthamount1,eOthincome2,eOthamount2,eOthincome3,eOthamount3,eOthincome4,eOthamount4,eOthincome5,eOthamount5,eProvifund,eProftax,eEsi,eDeduc1,eDeduc2,eDeduc3,eDeduc4,eDeducamt1,eDeducamt2,eDeducamt3,eDeducamt4,cid_id
#     eName=ename.get()
#     eJoiningdate=ejoiningdate.get()
#     eEmployeenumber=eemployeenumber.get()
#     eDesignation=edesignation.get()
#     eDepartment=edepartment.get()
#     eBranch=ebranch.get()
#     eLocation=elocation.get()
#     eGender=egender.get()
#     eAge=eage.get()
#     eMobile=emobile.get()
#     eGmail=egmail.get()
#     eAddress=eaddress.get()
#     # Providebankdetails=providebankdetails.get()
#     eBankaccountnumber=ebankaccountnumber.get()
#     eIfsccode=eifsccode.get()
#     eTotalrentpaid=etotalrentpaid.get()
#     eHrareceived=ehrareceived.get()
#     eLivein=elivein.get()
#     eApplicabletaxregime=eapplicabletaxregime.get()
#     ePannumber=epannumber.get()
#     eAadhaarnumber=eaadhaarnumber.get()
#     eUniversalaccountnumber=euniversalaccountnumber.get()
#     ePfaccountnumber=epfaccountnumber.get()
#     eEpsaccountnumber=eepsaccountnumber.get()
#     ePraccountnumber=epraccountnumber.get()
#     eEsinumber=eesinumber.get()
#     eEsidispensaryname=eesidispensaryname.get()
#     eBasic=ebasic.get()
#     eDa=eda.get()
#     eOthincome1=eothincome1.get()
#     eOthamount1=eothamount1.get()
#     eOthincome2=eothincome2.get()
#     eOthamount2=eothamount2.get()
#     eOthincome3=eothincome3.get()
#     eOthamount3=eothamount3.get()
#     eOthincome4=eothincome4.get()
#     eOthamount4=eothamount4.get()
#     eOthincome5=eothincome5.get()
#     eOthamount5=eothamount5.get()
#     eProvifund=eprovifund.get()
#     eProftax=eproftax.get()
#     eEsi=eesi.get()
#     eDeduc1=ededuc1.get()
#     eDeduc2=ededuc2.get()
#     eDeduc3=ededuc3.get()
#     eDeduc4=ededuc4.get()
#     eDeducamt1=ededucamt1.get()
#     eDeducamt2=ededucamt2.get()
#     eDeducamt3=ededucamt3.get()
#     eDeducamt4=ededucamt4.get()
#     cid_id=cmp1[0]
...
#     val=(eName,eJoiningdate,eEmployeenumber,eDesignation,eDepartment,eBranch,eLocation,eGender,eAge,eMobile,eGmail,eAddress,eprovidebankdetails,eBankaccountnumber,eIfsccode,eTotalrentpaid,eHrareceived,eLivein,eApplicabletaxregime,ePannumber,eAadhaarnumber,eUniversalaccountnumber,ePfaccountnumber,eEpsaccountnumber,ePraccountnumber,eEsinumber,eEsidispensaryname,eBasic,eDa,eOthincome1,eOthamount1,eOthincome2,eOthamount2,eOthincome3,eOthamount3,eOthincome4,eOthamount4,eOthincome5,eOthamount5,eProvifund,eProftax,eEsi,eDeduc1,eDeduc2,eDeduc3,eDeduc4,eDeducamt1,eDeducamt2,eDeducamt3,eDeducamt4,cid_id)
...
#     global ename,ejoiningdate,eemployeenumber,edesignation,edepartment,ebranch,elocation,egender,eage,emobile,egmail,eaddress,eprovidebankdetails,ebankaccountnumber,eifsccode,etotalrentpaid,ehrareceived,elivein,eapplicabletaxregime,epannumber,eaadhaarnumber,euniversalaccountnumber,epfaccountnumber,eepsaccountnumber,epraccountnumber,eesinumber,eesidispensaryname,ebasic,eda,eothincome1,eothamount1,eothincome2,eothamount2,eothincome3,eothamount3,eothincome4,eothamount4,eothincome5,eothamount5,eprovifund,eproftax,eesi,ededuc1,ededuc2,ededuc3,ededuc4,ededucamt1,ededucamt2,ededucamt3,ededucamt4

#     ename=StringVar()
#     ejoiningdate=StringVar()
#     eemployeenumber=StringVar()
#     edesignation=StringVar()
...
#     ebankaccountnumber=StringVar()
#     eifsccode=StringVar()
#     etotalrentpaid=StringVar()
#     ehrareceived=StringVar()
#     elivein=StringVar()
#     eapplicabletaxregime=StringVar()
#     epannumber=StringVar()
#     eaadhaarnumber=StringVar()
#     euniversalaccountnumber=StringVar()
#     epfaccountnumber=StringVar()
#     eepsaccountnumber=StringVar()
#     epraccountnumber=StringVar()
#     eesinumber=StringVar()
#     eesidispensaryname=StringVar()
#     ebasic=StringVar()
#     eda=StringVar()
#     eothincome1=StringVar()
#     eothamount1=StringVar()
#     eothincome2=StringVar()
#     eothamount2=StringVar()
#     eothincome3=StringVar()
#     eothamount3=StringVar()
#     eothincome4=StringVar()
#     eothamount4=StringVar()
#     eothincome5=StringVar()
#     eothamount5=StringVar()
#     eprovifund=StringVar()
#     eproftax=StringVar()
#     eesi=StringVar()
#     ededuc1=StringVar()
#     ededuc2=StringVar()
#     ededuc3=StringVar()
#     ededuc4=StringVar()
#     ededucamt1=StringVar()
#     ededucamt2=StringVar()
#     ededucamt3=StringVar()
#     ededucamt4=StringVar()
...
#     label2=Entry(F,bg='#2f516a',fg='#fff',textvariable=ename)
...
#     cal2 = DateEntry(F, width= 22, font=('times new roman', 12, 'bold'),bg="#243e55",fg="#243e55", bd=5, relief=GROOVE,textvariable=ejoiningdate)
...
#     label4=Entry(F,bg='#2f516a',fg='#fff',textvariable=eemployeenumber)
...
#     label2=Entry(F,bg='#2f516a',fg='#fff',textvariable=edesignation)
...
#     label3=Entry(F,bg='#2f516a',fg='#fff',textvariable=edepartment)
...
#     label4=Entry(F,bg='#2f516a',fg='#fff',textvariable=ebranch)
...
#     label2=Entry(F,bg='#2f516a',fg='#fff',textvariable=elocation)
...
#     drop2=ttk.Combobox(F,textvariable =egender)
...
#     place_input=StringVar()
#     drop3=ttk.Combobox(F,textvariable =eage)
...
#     label2=Entry(F,bg='#2f516a',fg='#fff',textvariable=emobile)
...
#     label3=Entry(F,bg='#2f516a',fg='#fff',textvariable=egmail)
...
#     label2=Entry(F,bg='#2f516a',fg='#fff',textvariable=eaddress)
...
#             lab=Entry(F,bg='#2f516a',fg='#fff',textvariable=ebankaccountnumber)
...
#             lab1=Entry(F,bg='#2f516a',fg='#fff',textvariable=eifsccode)
#             lab1.place(x=790,y=730,height=40,width=360)
#             eprovidebankdetails="Yes"
#         elif Choice == 2:
#             output = "No"
#             eprovidebankdetails ="No"
#         else:
#             output = "Invalid"
...
#     label2=Entry(F,bg='#2f516a',fg='#fff',textvariable=etotalrentpaid)
...
#     label3=Entry(F,bg='#2f516a',fg='#fff',textvariable=ehrareceived)
...
#     drop1=ttk.Combobox(F,textvariable=elivein)
#     drop1['values']=("Yes","No")
...
#     label2=Entry(F,bg='#2f516a',fg='#fff',textvariable=eapplicabletaxregime)
...
#     label2=Entry(F,bg='#2f516a',fg='#fff',textvariable=epannumber)
...
#     label3=Entry(F,bg='#2f516a',fg='#fff',textvariable=eaadhaarnumber)
...
#     label2=Entry(F,bg='#2f516a',fg='#fff',textvariable=euniversalaccountnumber)
...
#     label3=Entry(F,bg='#2f516a',fg='#fff',textvariable=epfaccountnumber)
...
#     label2=Entry(F,bg='#2f516a',fg='#fff',textvariable=eepsaccountnumber)
...
#     label3=Entry(F,bg='#2f516a',fg='#fff',textvariable=epraccountnumber)
...
#     label2=Entry(F,bg='#2f516a',fg='#fff',textvariable=eesinumber)
...
#     label3=Entry(F,bg='#2f516a',fg='#fff',textvariable=eesidispensaryname)
...
#     label1=Entry(F,bg='#2f516a',fg='#fff',textvariable=ebasic)
...
#     label1=Entry(F,bg='#2f516a',fg='#fff',textvariable=eda)
#     label1.place(x=280,y=1760,height=40,width=230)

#     label1=Entry(F,bg='#2f516a',fg='#fff',textvariable=eothincome1)
#     label1.place(x=40,y=1820,height=40,width=230)
#     label1=Entry(F,bg='#2f516a',fg='#fff',textvariable=eothamount1)
#     label1.place(x=280,y=1820,height=40,width=230)

#     label1=Entry(F,bg='#2f516a',fg='#fff',textvariable=eothincome2)
#     label1.place(x=40,y=1880,height=40,width=230)
#     label1=Entry(F,bg='#2f516a',fg='#fff',textvariable=eothamount2)
#     label1.place(x=280,y=1880,height=40,width=230)

#     label1=Entry(F,bg='#2f516a',fg='#fff',textvariable=eothincome3)
#     label1.place(x=40,y=1940,height=40,width=230)
#     label1=Entry(F,bg='#2f516a',fg='#fff',textvariable=eothamount3)
#     label1.place(x=280,y=1940,height=40,width=230)

#     label1=Entry(F,bg='#2f516a',fg='#fff',textvariable=eothincome4)
#     label1.place(x=40,y=2000,height=40,width=230)
#     label1=Entry(F,bg='#2f516a',fg='#fff',textvariable=eothamount4)
#     label1.place(x=280,y=2000,height=40,width=230)

#     label1=Entry(F,bg='#2f516a',fg='#fff',textvariable=eothincome5)
#     label1.place(x=40,y=2060,height=40,width=230)
#     label1=Entry(F,bg='#2f516a',fg='#fff',textvariable=eothamount5)
...
#     label1=Entry(F,bg='#2f516a',fg='#fff',textvariable=eprovifund)
...
#     label1=Entry(F,bg='#2f516a',fg='#fff',textvariable=eproftax)
...
#     label1=Entry(F,bg='#2f516a',fg='#fff',textvariable=eesi)
#     label1.place(x=940,y=1820,height=40,width=230)

#     label1=Entry(F,bg='#2f516a',fg='#fff',textvariable=ededuc1)
#     label1.place(x=700,y=1880,height=40,width=230)
#     label1=Entry(F,bg='#2f516a',fg='#fff',textvariable=ededucamt1)
#     label1.place(x=940,y=1880,height=40,width=230)

#     label1=Entry(F,bg='#2f516a',fg='#fff',textvariable=ededuc2)
#     label1.place(x=700,y=1940,height=40,width=230)
#     label1=Entry(F,bg='#2f516a',fg='#fff',textvariable=ededucamt2)
#     label1.place(x=940,y=1940,height=40,width=230)

#     label1=Entry(F,bg='#2f516a',fg='#fff',textvariable=ededuc3)
#     label1.place(x=700,y=2000,height=40,width=230)
#     label1=Entry(F,bg='#2f516a',fg='#fff',textvariable=ededucamt3)
#     label1.place(x=940,y=2000,height=40,width=230)

#     label1=Entry(F,bg='#2f516a',fg='#fff',textvariable=ededuc4)
#     label1.place(x=700,y=2060,height=40,width=230)
#     label1=Entry(F,bg='#2f516a',fg='#fff',textvariable=ededucamt4)
...
b1 = Button(F,text = "Add Employees",bg="#243e55",fg="#fff",font=('times new roman', 16, 'bold'),command=add_Employee)  
