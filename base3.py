...
class base:
    ...
    def main(self):
      ...
      #  root.iconphoto(False, p1)
        ...
        bankopt = tk.OptionMenu(lab, bankvariable, *OptionList,command=bank)
        bankopt.config(width=10, bg="#213b52",fg="#fff",font=('Helvetica', 12, 'bold'))
        bankopt.place(x=160,y=120)
        ...
        salesopt = tk.OptionMenu(lab, salesvariable, *OptionList,command=salesrec)
        salesopt.config(width=10, bg="#213b52",fg="#fff",font=('Helvetica', 12, 'bold'))
        salesopt.place(x=310,y=120)
        ...
        expopt = tk.OptionMenu(lab, expvariable, *OptionList,command=exp_supp)
        expopt.config(width=10, bg="#213b52",fg="#fff",font=('Helvetica', 12, 'bold'))
        expopt.place(x=460,y=120)
        ...
        reportopt = tk.OptionMenu(lab, reportvariable, *OptionList,command=reportsec)
        reportopt.config(width=10, bg="#213b52",fg="#fff",font=('Helvetica', 12, 'bold'))
        reportopt.place(x=760,y=120)
