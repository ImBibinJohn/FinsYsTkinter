...
def add_recon1():
    ...
    straccount = str(accounttype)
    beginningbalance=beginningbalance.get(),
    strbeginningbalance = str(beginningbalance)
    endingbalance=endingbalance.get(),
    strendingbalance = str(endingbalance)
    endingdate=endingdate.get(),
    strendingdate = str(endingdate)
    edat=edat.get(),
    stredat = str(edat)
    serchar=serchar.get(),
    strserchar = str(serchar)
    expacc=expacc.get(),
    strexpacc = str(expacc)
    idat1=idat1.get(),
    stridat1 = str(idat1)
    intear=intear.get(),
    strintear = str(intear)
    incacc=incacc.get(),
    strincacc = str(incacc)
    cid_id=1
    ...
    val=(straccount,strbeginningbalance,strendingbalance,strendingdate,stredat,strserchar,strexpacc,stridat1,strintear,strincacc,cid_id)
    ...
    sql = 'SELECT edat,accounttype,recon1id,expacc,beginningbalance,serchar,recon1id from app1_recon1'
...
#         cur = sqlcon.cursor()
#         cur.execute("INSERT INTO app1_recon1 (accounttype,beginningbalance,endingbalance ,endingdate,edat,serchar,expacc ,idat1 ,intear ,incacc) values (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)", (
