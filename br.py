...
def add_invoice():
    ...
    def add_custom():
        ...
        addcustomer_form.geometry("1000x1000")
        ...
        full_frame=Frame(mycanvas,width=1000,height=2000,bg='#2f516a')
        ...
        form_frame=Frame(mycanvas,width=1000,height=1000,bg='#243e55')
    ...
    invoice_form.geometry("1000x2000")
    ...
    full_frame=Frame(mycanvas,width=1000,height=2500,bg='#2f516a')
    mycanvas.create_window((0,0),window=full_frame,anchor="nw")
    ...
    form_frame=Frame(mycanvas,width=1000,height=1900,bg='#243e55')
    mycanvas.create_window((150,150),window=form_frame,anchor="nw")
...
def edit_customer():
    ...
    editinvoice_form.geometry("1000x2000")
...
add_invoices.place(x=1050,y=100)
